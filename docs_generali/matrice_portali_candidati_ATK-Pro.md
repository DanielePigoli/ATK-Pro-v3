...
| `bub_digitale` | Italia / Emilia-Romagna | pagina ufficiale BUB Digitale, IIIF e Mirador dichiarati; `verify_bub_technical_probe.py`; `verify_manifest_url.py` | Candidato forte da promuovere con cautela: due bollettini parrocchiali verificati con manifest IIIF v2, 44 e 32 canvas; resta da fissare licenza item-level, range e prova di download controllata |

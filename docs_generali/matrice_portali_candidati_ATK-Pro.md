...
| `ambrosiana_digitale` | Veneranda Biblioteca Ambrosiana - Digital Library | Italia / Lombardia ecclesiastica e manoscritti | `https://www.ambrosiana.it/en/discover/masterpieces/the-digital-library/`; `https://ambrosiana.comperio.it/library-digital/`; esempi Comperio `https://ambrosiana.comperio.it/opac/detail/view/ambro:catalog:24203`; campione pubblico UniCatt/Veneranda `https://digitallibrary.unicatt.it/veneranda/data/public/manifests/0b/02/da/82/80/0d/10/a0/0b02da82800d10a0.json` | Alta per manoscritti, codici, fondi storici e fonti culturali collegate a Milano e Lombardia | Controllo 2026-06-07/2026-07-25: la pagina ufficiale descrive accesso libero e uso dello standard IIIF; fonte accademica conferma Mirador e Cantaloupe. Test live su `ambro:catalog:24203`: trovati solo record Comperio duplicati/correlati e asset grafico, nessun manifest, info.json, immagine Cantaloupe o viewer utile. Verifica aggiuntiva su piattaforma pubblica UniCatt/Veneranda: manifest IIIF scaricato con codice 200 e 101 canvas. La pista tecnica esiste quindi davvero, ma la UI pubblica segnala `No Downloadable`; senza termini item-level compatibili o autorizzazione esplicita al download, il ramo resta fuori dal downloader | B/C - valore alto e IIIF pubblico confermato, ma integrazione sospesa per restrizione `No Downloadable` e assenza di termini item-level che autorizzino il download |
...
| `biblioteche_digitali_locali_iiif` | Italia | esempi da selezionare da biblioteche civiche, universitarie, comunali o regionali; ramo Unibo `https://archiviostorico.unibo.it/iiif/2/manifest/archiviostorico/riviste/libro_e_moschetto_1927-1943/0131.016.json` con manifest figli `https://archiviostorico.unibo.it/iiif/2/manifest/archiviostorico/riviste/libro_e_moschetto_1927-1943/0131.016/0131.016.003.json` e `https://archiviostorico.unibo.it/iiif/2/manifest/archiviostorico/riviste/libro_e_moschetto_1927-1943/0131.016/0131.016.022.json`; campione fotografico Unibo `https://archiviostorico.unibo.it/iiif/2/manifest/archiviostorico/archivio_fotografico/edilizia-universitaria/sezione-moderna/laboratori-delle-arti.json`; campione forte Padova `https://phaidra.unipd.it/api/object/o:369506/iiifmanifest`; campioni prudenziali aggiuntivi Padova `https://phaidra.unipd.it/api/object/o:327971/iiifmanifest` e `https://phaidra.unipd.it/api/object/o:566070/iiifmanifest`; sonda dedicata `verify_phaidra_technical_probe.py` | Buona pista tecnica se IIIF pubblico e policy prudente `R_LIMITED`; il primo sottoblocco ha prodotto BDT, BDL, Rovereto, BUB, FICLIT e ora anche il supporto prudente `archiviostorico_unibo` su manifest item-level pubblici. Aggiornamento 2026-07-25: `archiviostorico.unibo.it` ha superato la soglia minima per il supporto tecnico diretto su manifest record-level, mentre le collection di annata restano da trattare solo come fonte di scouting e non come input operativo. Nello stesso giorno `phaidra.unipd.it` conferma un secondo dominio distinto e pubblico, con manifest IIIF record-level da 442 canvas e una sonda tecnica prudente pronta anche a segnalare notice diritti come `All rights reserved` nel markup pubblico. Aggiornamento 2026-07-26: PHAIDRA non e' ancora promosso, ma esce dal blocco "serve un secondo oggetto" grazie ai campioni pubblici `o:327971` e `o:566070`, entrambi con manifest IIIF stabile e licenza item-level meno restrittiva del primo caso. Il ramo rientra quindi in `REVIEW` prudente e va rivalutato sul rapporto tra manifest, download pubblico ed etichetta diritti item-level prima di qualsiasi promozione |
| `mlol_digital_humanities_italia` | Italia | MLOL Digital Humanities `https://www.medialibrary.it/solution/digitalhumanities`; Comune di Bologna / ARBOR `https://www.comune.bologna.it/novita/comunicati-stampa/restart-la-cultura-bologna-e-digitale-concluso-il-progetto-di-potenziamento-delle-tecnologie-ambito`; `https://www.comune.bologna.it/novita/comunicati-stampa/e-online-una-versione-completamente-rinnovata-il-sito-web-dellarchiginnasio`; campione `https://arbor.medialibrary.it/item/185016bb-0d54-412f-9554-5eec348b09f0`; sonda `verify_mlol_dh_technical_probe.py`; piste aggiuntive `https://archiviocanova.medialibrary.it/`, `https://archiviogazzettadiparma.medialibrary.it/`, `https://istitutosvizzero.medialibrary.it/` e `https://lodovico.medialibrary.it/` | Controllo 2026-07-24/25: famiglia tecnica promettente per nuove biblioteche digitali locali IIIF. MLOL DH dichiara viewer integrato, documenti IIIF ad alta risoluzione, OCR compatibile con IIIF e piu' portali culturali italiani nello stesso ecosistema. Il campione pubblico ARBOR del Comune di Bologna e presentato come piattaforma basata su IIIF per le raccolte digitali dell'Archiginnasio e delle biblioteche di conservazione/specializzate comunali. Verifica live: la pagina pubblica ARBOR espone `/iiif/{id}/manifest`, un link Mirador e un manifest pieno `https://archiginnasio.jarvis.memooria.org/meta/iiif/185016bb-0d54-412f-9554-5eec348b09f0/manifest`; `verify_manifest_url.py` lo ha scaricato con codice 200 e 103 canvas. I controlli aggiuntivi su host affini reali (`archiviocanova`, `archiviogazzettadiparma`, `istitutosvizzero`, `lodovico`) confermano un ecosistema pubblico vivo, ma ancora esposto soprattutto in forma vetrina/galleria e non record-level nel flusso ospite. Aggiornamento 2026-07-26: il ricontrollo live su `archiviogazzettadiparma` e `lodovico`, sia su `home/index.aspx` sia su `media/esplora.aspx`, restituisce ancora `NO_GO`: emergono pagine informative e immagini di copertina/galleria, ma non item pubblici `/item/{guid}` o manifest Jarvis stabili. Il ramo resta quindi congelato finche' non emerge un terzo host con vera pagina item pubblica e manifest IIIF stabile | B - famiglia tecnica concreta con un campione pubblico valido, ma temporaneamente congelata finche' non emerge un terzo host realmente record-level |
| `memooria_jarvis_istanze_italiane` | Italia | istanze pubbliche Jarvis/Memooria da verificare per ente; riferimenti tecnici ufficiali `https://www.memooria.org/servizi-openjarvis/` e case study Estense `https://memooria.org/caso-studio/estense-digital-library/`; campione emerso da ARBOR `https://archiginnasio.jarvis.memooria.org/meta/iiif/185016bb-0d54-412f-9554-5eec348b09f0/manifest` | Controllo 2026-07-24/25: le fonti ufficiali confermano OpenJarvis come famiglia IIIF/Image/Presentation API con WebAPI REST e gateway di sicurezza, e documentano almeno un'installazione italiana dedicata per la Biblioteca Estense Universitaria. Il micro-scouting su ARBOR ha inoltre fatto emergere un'istanza pubblica reale `archiginnasio.jarvis.memooria.org` con manifest IIIF scaricabile e valido (103 canvas) esposto dalla pagina pubblica `arbor.medialibrary.it/item/...`. I controlli successivi su domini MLOL DH affini come `archiviocanova.medialibrary.it`, `archiviogazzettadiparma.medialibrary.it`, `istitutosvizzero.medialibrary.it` e `lodovico.medialibrary.it` confermano che esistono altri host pubblici di collezioni digitali, ma non ancora un terzo campione record-level con manifest/item pubblicamente esposto. La famiglia resta quindi documentata e riapribile, ma temporaneamente congelata finche' non emerge un host pubblico aggiuntivo davvero riusabile | B - famiglia tecnica concreta con almeno un'istanza italiana pubblica verificata, ma congelata in attesa di un terzo host record-level |
...
- Considerare riaperto in modo prudente il sottoramo MLOL Digital Humanities:
  ARBOR del Comune di Bologna dimostra che la famiglia esiste anche in area
  italiana pubblica e istituzionale, ma il prossimo passo deve essere una
  sonda tecnica dedicata su un campione manifesto/immagine stabile, non

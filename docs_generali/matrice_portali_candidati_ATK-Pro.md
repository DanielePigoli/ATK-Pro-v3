...
| `biblioteche_digitali_locali_iiif` | Italia | esempi da selezionare da biblioteche civiche, universitarie, comunali o regionali; campione forte Unibo `https://archiviostorico.unibo.it/iiif/2/manifest/archiviostorico/riviste/libro_e_moschetto_1927-1943/0131.016.json` con manifest figli `https://archiviostorico.unibo.it/iiif/2/manifest/archiviostorico/riviste/libro_e_moschetto_1927-1943/0131.016/0131.016.003.json` e `https://archiviostorico.unibo.it/iiif/2/manifest/archiviostorico/riviste/libro_e_moschetto_1927-1943/0131.016/0131.016.022.json`; campione fotografico Unibo `https://archiviostorico.unibo.it/iiif/2/manifest/archiviostorico/archivio_fotografico/edilizia-universitaria/sezione-moderna/laboratori-delle-arti.json`; campione forte Padova `https://phaidra.unipd.it/api/object/o:369506/iiifmanifest`; sonda dedicata `verify_phaidra_technical_probe.py` | Buona pista tecnica se IIIF pubblico e policy prudente `R_LIMITED`; il primo sottoblocco ha prodotto BDT, BDL e Rovereto, mentre BEIC e Ambrosiana restano sospese. Aggiornamento 2026-07-25: `archiviostorico.unibo.it` emerge come candidato universitario molto promettente, con collection IIIF v2 pubbliche coerenti su piu' livelli (radice e annata), almeno due manifest figli verificati live con 4 e 8 canvas e un manifest distinto dell'archivio fotografico verificato live con 7 canvas. Nello stesso giorno `phaidra.unipd.it` conferma un secondo dominio distinto e pubblico, con manifest IIIF record-level da 442 canvas e una sonda tecnica prudente gia' pronta per pagina oggetto, manifest, PDF e export metadati. Priorita' operativa attuale: prima valutare una promozione prudente del ramo Unibo; PHAIDRA resta subito dietro, ma con piu' cautela sui diritti item-level |

...
| `dl_ficlit` | FICLIT Digital Library / Universita di Bologna | Italia / Emilia-Romagna | `https://dl.ficlit.unibo.it/s/lib/page/progetto`; campione `https://dl.ficlit.unibo.it/s/lib/item/199245` | Media: collezioni accademiche e umanistiche, fonti letterarie, bibliografiche e documentarie utili a ricerche storiche territoriali | Controllo 2026-06-08: fonte ufficiale descrive piattaforma Omeka S, tecnologia IIIF per immagini e visualizzazione con Mirador Viewer. Primo test live 2026-06-09 su item Corbiere `199245`: la sonda trova immagine originale pubblica e manifest `https://dl.ficlit.unibo.it/iiif/2/199245/manifest`; `verify_manifest_url.py` scarica il manifest con codice 200 e rileva 1 canvas. Servono secondo campione, verifica termini item set e distinzione tra collezioni liberamente scaricabili e sola consultazione | B/A - candidato tecnico Omeka/IIIF concreto; valutare supporto `R_LIMITED` solo dopo almeno un secondo campione e policy item-level |
...
| `dl_ficlit` | Italia / Emilia-Romagna | pagina ufficiale DL FICLIT, Omeka S, IIIF e Mirador dichiarati; `verify_ficlit_technical_probe.py`; `verify_manifest_url.py` | Primo campione Corbiere `199245` positivo: manifest IIIF v2 scaricato con codice 200 e 1 canvas; cercare secondo campione prima di promozione |

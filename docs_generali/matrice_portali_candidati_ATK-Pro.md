...
| `mlol_digital_humanities_italia` | Italia | MLOL Digital Humanities `https://www.medialibrary.it/solution/digitalhumanities`; Comune di Bologna / ARBOR `https://www.comune.bologna.it/novita/comunicati-stampa/restart-la-cultura-bologna-e-digitale-concluso-il-progetto-di-potenziamento-delle-tecnologie-ambito`; `https://www.comune.bologna.it/novita/comunicati-stampa/e-online-una-versione-completamente-rinnovata-il-sito-web-dellarchiginnasio` | Primo controllo 2026-07-24: famiglia tecnica promettente per nuove biblioteche digitali locali IIIF. MLOL DH dichiara viewer integrato, documenti IIIF ad alta risoluzione, OCR compatibile con IIIF e piu' portali culturali italiani nello stesso ecosistema. Il campione pubblico ARBOR del Comune di Bologna e presentato come piattaforma basata su IIIF per le raccolte digitali dell'Archiginnasio e delle biblioteche di conservazione/specializzate comunali. Restano pero da verificare un campione tecnico stabile manifest/immagine, i termini/licenze effettivi del portale/item e l'eventuale riusabilita' del pattern su altri host MLOL DH | B/C - famiglia tecnica concreta e riapribile, ma non ancora da integrare senza sonda dedicata, campione pubblico stabile e policy item-level leggibile |
| `memooria_jarvis_istanze_italiane` | Italia | istanze pubbliche Jarvis/Memooria da verificare per ente; riferimenti tecnici ufficiali `https://www.memooria.org/servizi-openjarvis/` e case study Estense `https://memooria.org/caso-studio/estense-digital-library/` | Primo controllo 2026-07-24: le fonti ufficiali confermano OpenJarvis come famiglia IIIF/Image/Presentation API con WebAPI REST e gateway di sicurezza, e documentano almeno un'installazione italiana dedicata per la Biblioteca Estense Universitaria. Tuttavia non emerge ancora una rosa chiara di nuove istanze italiane pubbliche no-login, oltre ai casi gia noti o gia coperti da altri adapter. Tenere la famiglia come pista tecnica riapribile, ma non promuovere nuovi host finche non compare almeno un record pubblico stabile e istituzionale | B/C - famiglia tecnica promettente ma ancora senza nuova istanza italiana pubblica chiaramente candidabile oltre ai casi gia noti |

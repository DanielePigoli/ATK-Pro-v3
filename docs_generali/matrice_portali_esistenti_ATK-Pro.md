...
| `dl_ficlit` | FICLIT Digital Library | Italia / Emilia-Romagna | IIIF diretto da item Omeka S o manifest FICLIT | Basso-Medio | Condizioni d'uso specifiche per item set/collezione; corretta citazione richiesta | Supportare solo item/manifest FICLIT pubblici, con range esplicito e verifica termini item-level |

...
SWEDISH_GUIDE_MODULES = ITALIAN_GUIDE_MODULES.copy()
ROMANIAN_GUIDE_MODULES = ITALIAN_GUIDE_MODULES.copy()
POLISH_GUIDE_MODULES = ITALIAN_GUIDE_MODULES.copy()

GREEK_GUIDE_MODULES = ITALIAN_GUIDE_MODULES.copy()

RUSSIAN_GUIDE_MODULES = ITALIAN_GUIDE_MODULES.copy()

TURKISH_GUIDE_MODULES = ITALIAN_GUIDE_MODULES.copy()

VIETNAMESE_GUIDE_MODULES = ITALIAN_GUIDE_MODULES.copy()

CHINESE_GUIDE_MODULES = ITALIAN_GUIDE_MODULES.copy()

JAPANESE_GUIDE_MODULES = ITALIAN_GUIDE_MODULES.copy()

ARABIC_GUIDE_MODULES = ITALIAN_GUIDE_MODULES.copy()

HEBREW_GUIDE_MODULES = ITALIAN_GUIDE_MODULES.copy()
...
def expected_guide_modules(lang_dir: Path) -> list[str]:
    ...
    if lang_dir.name == "pt":
        return PORTUGUESE_GUIDE_MODULES
    if lang_dir.name == "fr":
    ...
    if lang_dir.name == "sv":
        return SWEDISH_GUIDE_MODULES
    if lang_dir.name == "ro":
        return ROMANIAN_GUIDE_MODULES
    if lang_dir.name == "pl":
    ...
    if lang_dir.name == "tr":
        return TURKISH_GUIDE_MODULES
    if lang_dir.name == "vi":
        return VIETNAMESE_GUIDE_MODULES
    if lang_dir.name == "zh":
...
def main() -> int:
    ...
    print(
        ...
        f"Turkish {len(TURKISH_GUIDE_MODULES)}, "
        ...
        f"Hebrew {len(HEBREW_GUIDE_MODULES)}, "

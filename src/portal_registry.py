...
_PORTALS: tuple[PortalInfo, ...] = (
    ...
    PortalInfo(
        key="dl_ficlit",
        label="FICLIT Digital Library (Universita di Bologna)",
        group="\u2500\u2500 Italia \u2500\u2500",
        area="Italia / Emilia-Romagna",
        technical_family="iiif_direct",
        method="IIIF diretto da item Omeka S o manifest FICLIT",
        maintenance_risk="Basso-Medio",
        roadmap_priority="maintain_with_warning",
        operational_note="Collezioni Omeka/IIIF pubbliche; verificare sempre termini item set e usare range esplicito per registri.",
        default_referer="https://dl.ficlit.unibo.it",
        tile_max_workers=1,
        tile_inter_delay=0.3,
        record_mode_policy="r_limited",
        policy_checked_at="2026-06-09",
        policy_source_urls=(
            "https://dl.ficlit.unibo.it/s/lib/page/progetto",
            "https://dl.ficlit.unibo.it/s/lib/page/collezioni",
        ),
    ),
    PortalInfo(
        key="archiviostorico_unibo",
        label="Archivio Storico Universita di Bologna",
        group="\u2500\u2500 Italia \u2500\u2500",
        area="Italia / Emilia-Romagna",
        technical_family="iiif_direct",
        method="IIIF diretto da manifest pubblico Archivi Storici Unibo",
        maintenance_risk="Basso-Medio",
        roadmap_priority="maintain_with_warning",
        operational_note="Supportare solo manifest pubblici item-level; evitare collection di annata e verificare sempre diritti/licenza del singolo oggetto.",
        default_referer="https://archiviostorico.unibo.it",
        tile_max_workers=1,
        tile_inter_delay=0.3,
        record_mode_policy="r_limited",
        policy_checked_at="2026-07-25",
        policy_source_urls=(
            "https://archiviostorico.unibo.it/",
            "https://archiviostorico.unibo.it/it/chi-siamo",
        ),
    ),
    PortalInfo(
        key="phaidra_unipd",
        label="PHAIDRA Universita di Padova",
        group="\u2500\u2500 Italia \u2500\u2500",
        area="Italia / Veneto",
        technical_family="iiif_direct",
        method="IIIF diretto da pagina oggetto o manifest PHAIDRA ufficiale",
        maintenance_risk="Basso-Medio",
        roadmap_priority="maintain_with_warning",
        operational_note="Supportare solo manifest item-level pubblici PHAIDRA; verificare sempre rights notice, licenza item-level e coerenza tra manifest e download.",
        default_referer="https://phaidra.cab.unipd.it",
        tile_max_workers=1,
        tile_inter_delay=0.3,
        record_mode_policy="r_limited",
        ...
        policy_source_urls=(
            ...
            "https://bibliotecadigitale.cab.unipd.it/bd/phaidra",
            "https://bibliotecadigitale.cab.unipd.it/bd/diritti",
        ),
    ),
    PortalInfo(
    ...
    PortalInfo(
        ...
        technical_family="synthetic_manifest",
        method="Manifest sintetico multipagina da BookReader e Cantaloupe IIIF",
        maintenance_risk="Basso-Medio",
        roadmap_priority="maintain_with_warning",
        operational_note="Sequenza BookReader pubblica; elaborazione prudente e seriale delle immagini Cantaloupe, con fallback PDF REST.",
    ...
    PortalInfo(
        key="doge_unige",
        label="DOGE Digital Library",
        group="\u2500\u2500 Italia \u2500\u2500",
        area="Italia / Liguria",
        technical_family="synthetic_manifest",
        method="Manifest sintetico da derivati pubblici API DSpace-GLAM",
        maintenance_risk="Medio",
        roadmap_priority="maintain_with_warning",
        operational_note="Usare solo derivati pubblici `IIIF-ALTERNATIVE-LD` e PDF `IIIF-ALTERNATIVE-DOWNLOAD`; escludere `ORIGINAL` e `IIIF-PDF-*` bloccati/nodownload.",
        default_referer="https://doge.unige.net",
        tile_max_workers=1,
        tile_inter_delay=0.3,
        record_mode_policy="r_limited",
        policy_checked_at="2026-07-27",
        policy_source_urls=(
            "https://doge.unige.net/",
            "https://biblioteche.unige.it/doge_informazioni_generali",
            "https://biblioteche.unige.it/doge_servizi_offerti",
        ),
    ),
    PortalInfo(
        key="memooria",
...
PORTAL_HOST_HINTS: dict[str, str] = {
    ...
    "archiviostorico.unibo.it": "archiviostorico_unibo",
    "phaidra.cab.unipd.it": "phaidra_unipd",
    "phaidra.unipd.it": "phaidra_unipd",
